...
Tester l'autocompletion et validation YAML dans RStudio IDE [🔗](https://quarto.org/docs/tools/rstudio.html#yaml-intelligence)
:::
...
Allons plus pour produire des contenus plus élaboré avec Quarto 
