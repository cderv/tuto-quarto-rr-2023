...
## Le tiret `-` est utilisé à la place du point `.` dans Quarto.

Les deux fonctionnent pour les options **knitr**, mais la _vraie_ syntaxe Quarto est avec un tiret. 
Les options Quarto seront avec un tiret, et le tiret est nécessaire pour les options communes (ex. `fig-alt` pour Knitr et Jupyter)
:::
