...
**Ne pas créer de dossier R Studio car nous allons créer différents projets pour les exercies, et créer des sous-projets RStudio ne fonctionne pas bien**
...
-   La syntaxe Markdown pour Pandoc
    ...
    -   Elle est rappelée aussi pour Quarto : <https://quarto.org/docs/authoring/markdown-basics.html>
